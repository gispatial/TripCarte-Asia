export default {
  pages: {
    ...
    data: [
      // DASHBOARDS
      //{title: "Attractions and Merchants",        url: "/dashboard/ecommerce",                icon: "HomeIcon",           is_bookmarked: true},
      //{title: "eCommerce Dashboard",        url: "/dashboard/analytics",                icon: "HomeIcon",           is_bookmarked: false},
      ...
      // UI ELEMENTS
      { title: "Data List - List View",     url: "/ui-tripcarte/data-list/list-view",    icon: "ListIcon",           is_bookmarked: false},
      {title: "Data List - Thumb View",    url: "/ui-tripcarte/data-list/thumb-view",   icon: "ImageIcon",          is_bookmarked: false},
      {title: "Vuesax Grid",               url: "/ui-tripcarte/grid/vuesax",            icon: "LayoutIcon",         is_bookmarked: false},
      {title: "Tailwind Grid",             url: "/ui-tripcarte/grid/tailwind",          icon: "LayoutIcon",         is_bookmarked: false},
      {title: "Colors",                    url: "/ui-tripcarte/colors",                 icon: "DropletIcon",        is_bookmarked: false},
      {title: "Basic Cards",               url: "/ui-tripcarte/card/basic",             icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Statistics Card",           url: "/ui-tripcarte/card/statistics",        icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Analytics Cards",           url: "/ui-tripcarte/card/analytics",         icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Card Actions",              url: "/ui-tripcarte/card/card-actions",      icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Card Colors",               url: "/ui-tripcarte/card/card-colors",       icon: "FeatherIcon",        is_bookmarked: false},
      {title: "Table",                     url: "/ui-tripcarte/table",                  icon: "GridIcon",           is_bookmarked: false},
      {title: "agGrid Table",              url: "/ui-tripcarte/commissions",          icon: "GridIcon",           is_bookmarked: false},
  ...
  files: {
    ...
    data: [
      ...
      {file_name: "796925f256cacaade1", from:"QR Code", file_ext:"doc", size:"2.3 mb" },
