  ...
  data() {
    return {
      ...
      steps: [{
          ...
          content : 'Toggle Collapse Tripcarte Sidebar.'
        },
        {
          target  : '.vx-navbar__starred-pages',
          content : 'Create your own attractions bookmarks. You can also re-arrange them using drag & drop.'
        },
        {
          target  : '.i18n-locale',
        ...
        },
        {
          ...
          content : 'Customize Tripcarte based on your preferences',
          params  : {
            placement: 'left'
          }
        },
        {
          ...
          content : 'Thanks for using Tripcarte & start booking travel your destinations !',
          params  : {
            placement: 'top'
          }
        },
