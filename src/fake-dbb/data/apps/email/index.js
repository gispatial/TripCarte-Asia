...
let data = {
  emails: [
      ...
      replies: [
        {
          ...
          cc: [],
          bcc: [],
          message: '<p>Hello Hettie,</p><p><br></p><p>Marshmallow cookie jelly liquorice. Powder macaroon cake pastry biscuit. Cotton candy cotton candy jelly chocolate bar. Sesame snaps candy gummi bears cake cookie jujubes. Sweet I love sweet roll. Sesame snaps I love marzipan. Jelly powder tootsie roll. Marshmallow pudding cookie fruitcake liquorice powder. I love I love cookie chupa chups fruitcake ice cream I love biscuit I love. Tiramisu apple pie candy canes cookie gummies. Donut toffee bear claw topping jelly-o. Cupcake icing muffin. Cookie brownie wafer pie sweet. Icing sesame snaps halvah toffee marshmallow lemon drops jelly.</p><p><br></p><p>Tiramisu candy canes powder. Powder chocolate bar halvah liquorice cake I love danish. Cake wafer apple pie. Bear claw fruitcake I love marzipan dessert marzipan lollipop. Halvah gingerbread jelly chupa chups tiramisu I love wafer gummi bears. Candy powder caramels candy gummies. Tart tart cupcake brownie. Bear claw gummies toffee. Tiramisu donut cake chocolate bar. Halvah chocolate bar donut jelly-o. Icing candy brownie chocolate. Pastry bear claw halvah gummies chocolate bar chocolate. Apple pie danish wafer I love biscuit.</p><p><br></p><p>Regrads,</p><p>Demo User</p><p><br></p>',
          attachments: [],
          isStarred: false,
          labels: [],
    ...
    },
    {
      "id": 14,
      "sender": "info@tripcarte.asia",
      "sender_name": "Tripcarte.Asia Notifications",
    ...
    },
    {
      "id": 21,
      "sender": "info@tripcarte.asia",
      "sender_name": "Tripcarte.Asia Marketing Team",
    ...
    },
    {
      "id": 27,
      "sender": "info@tripcarte.asia",
      "sender_name": "Tripcarte.Asia Support",
      "to": ["noreply@tripcarte.asia"],
      "img": require('@/assets/images/portrait/small/avatar-s-3.jpg'),
      "subject": "Stay Safe At Home During Covid-19 📷 😃",
      "cc": [],
      "bcc": [],
      "message": "<p>Dear Respected Merchants & Partners, </p><p><br></p><p> We hopes u have that safe at home and please do abide by government restrictions during this crisis</p>",
