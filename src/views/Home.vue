  ...
  <div id="dashboard-analytics">
    ...
    <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl:w-1/3 mb-base">
      ...
      <vx-card slot="no-body" class="text-center bg-success-gradient greet-user">
        ...
        <div class="vx-row">
            <div class="vx-col w-full sm:w-1/3 md:w-1/4 lg:w-1/4 xl:w-1/4">
            <vs-button icon-pack="feather" icon="icon-chevrons-right" icon-after class="shadow-md w-full lg:mt-0 mt-4" href="/apps/todo/all">Details</vs-button>
