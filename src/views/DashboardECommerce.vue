...
<template>
  <div id="dashboard-analytics">
          ...
          <div slot="no-body" class="mt-4">
            <vs-table :data="dispatchedOrders" class="table-dark-inverted">
              <template slot="thead">
                ...
                <vs-th>Redempt Stats</vs-th>
                <vs-th>Pymnt Stats</vs-th>
                <vs-th>Pymnt Date</vs-th>
                <vs-th>Pymnt Reff</vs-th>
              </template>
            </vs-table>
          </div>
    ...
    <div>-----Tripcarte.Asia Finance Dashboard</div>
        ...
        <vx-card>
          <div class="vx-row flex-col-reverse md:flex-col-reverse sm:flex-row lg:flex-row">
            ...
            <div class="vx-col w-full md:w-full sm:w-1/2 lg:w-1/2 xl:w-1/2 flex flex-col justify-between" v-if="salesBarSession.analyticsData">
              <div>
                <h2 class="mb-1 font-bold">Myr 14,000</h2>
                <span class="font-medium">Total Redemption this Year</span>
