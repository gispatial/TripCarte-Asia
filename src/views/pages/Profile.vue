  ...
  data() {
    return {
      ...
      suggestedFriends: [
        ...
        { name: 'Demo User',      avatar: require("@/assets/images/portrait/small/avatar-s-11.jpg"), mutualFriends: 1 },
      ...
      polls: [{
        ...
        options: [{
            ...
            usersVoted : [
              ...
              { name: 'Demo User',       avatar: require("@/assets/images/portrait/small/avatar-s-11.jpg") },
              { name: 'Tonia Seabold',  avatar: require("@/assets/images/portrait/small/avatar-s-12.jpg") },
